...
const EditBlog = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState(blog?.coverImage || null);
        ...
        {isLoading || status === STATUSES.LOADING ? (
          ...
          >
            ...
            <label className="w-full cursor-pointer">
              <div className="w-full dark:border-[#242535] border-2 border-[#E8E8EA] border-dashed flex flex-col items-center justify-center py-6 text-[#696A75] dark:text-[#97989F] hover:border-[#4B6BFB] transition overflow-hidden">
                {previewUrl ? (
